...
<div id="login-screen" class="login-screen">
    <div class="login-card">
        <div class="login-kicker">Xoloitzcuintles</div>

        <h1 class="login-title">Jugadores Prestados</h1>

        <p class="login-subtitle">
            Acceso autorizado al sistema de seguimiento.
        </p>
...
<script>
    const SUPABASE_URL = "https://blukemyhkdixnprqiinb.supabase.co";

    const SUPABASE_KEY =
        "sb_publishable_OjgpEEPVqB5JLT6Jb_Oabw_1Ce9NFep";
